$(function(){
	...
	$('.sidebar-toggle').click(function(){
		var job_adminlte_settings = $.cookie('job_adminlte_settings');	// on=open，off=close
		if ('off' == job_adminlte_settings) {
            job_adminlte_settings = 'on';
		} else {
            job_adminlte_settings = 'off';
		}
		$.cookie('job_adminlte_settings', job_adminlte_settings, { expires: 7 });	//$.cookie('the_cookie', '', { expires: -1 });
	});

	// left menu status v1: js + cookie
	/*
	 var job_adminlte_settings = $.cookie('job_adminlte_settings');
	 if (job_adminlte_settings == 'off') {
