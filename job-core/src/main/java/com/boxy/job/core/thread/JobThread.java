package com.boxy.job.core.thread;
        ...
        while (!toStop) {
            ...
            try {
                ...
                if (triggerParam != null) {
                    ...
                    // execute
                    JobLogger.log("<br>----------- job job execute start -----------<br>----------- Param:" + triggerParam.getExecutorParams());
                    ...
                    if (triggerParam.getExecutorTimeout() > 0) {
                        ...
                        try {
                            ...
                            JobLogger.log("<br>----------- job job execute timeout");
                            JobLogger.log(e);
                    ...
                    JobLogger.log("<br>----------- job job execute end(finish) -----------<br>----------- ReturnT:" + executeResult);
